    ...
    <div>
      ...
      <div className="aboutmeDesc">
        ...
        <p>
          ...
          Developing applications that help bring ease and efficiency is the
          ...
          I feel at my best. I love participating in a team environment. Making
          progress and sharing progress with others brings me satisfaction. Life
          long learning is my goal. Constantly gaining knowledge and putting
          that knowledge into practice is my life goal.
        </p>
      </div>
      <div>
        ...
        <div className="skills-list text-center">
          <ul className="skills">
            ...
            <li className="css"><DiCss3Full /></li>
            <li className="js"><DiJsBadge /></li>
            <li className="node"><DiNodejs /></li>
            <li className="npm"><DiNpm /></li>
            <li className="jquery"><DiJqueryLogo /></li>
            <li className="react"><DiReact /></li>
            <li className="handlebars"><SiHandlebarsdotjs /></li>
            <li className="mongodb"><DiMongodb /></li>
            <li className="mysql"><DiMysql /></li>
            <li className="git"><DiGit /></li>
            <li className="github"><DiGithubBadge /></li>
            <li className="heroku"><DiHeroku /></li>
            <li className="vscode"><DiVisualstudio /></li>
          </ul>
        </div>
      </div>
    </div>
